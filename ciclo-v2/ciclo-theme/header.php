...
<div class="nav-fixed"><nav class="nav" aria-label="주 메뉴">
  <a class="nav-logo" href="/"><img src="data:image/webp;base64,UklGRhoAAABXRUJQVlA4TA0AAAAvAAAAEAcQERGIiP4HAA==" alt="CICLO" width="488" height="566" fetchpriority="high" decoding="async"><span>CICLO</span></a>
  <div class="nav-links">
...
<aside class="sidebar" id="ciclo-sidebar" role="dialog" aria-modal="true" aria-label="사이트 메뉴">
  <div class="sidebar-top">
    <div class="sidebar-brand"><img src="data:image/webp;base64,UklGRhoAAABXRUJQVlA4TA0AAAAvAAAAEAcQERGIiP4HAA==" alt="" width="488" height="566" loading="lazy" decoding="async"><span>CICLO</span></div>
