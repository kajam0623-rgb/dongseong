...
<header class="hero">
  <div class="hero-mark" aria-hidden="true"><img src="data:image/webp;base64,UklGRhoAAABXRUJQVlA4TA0AAAAvAAAAEAcQERGIiP4HAA==" alt="" width="488" height="566" fetchpriority="low" decoding="async"></div>
...
<section class="section navy evidence" id="evidence"><div class="wrap">
  ...
  <h2 class="sec-h2" style="color:#fff">치과 홈페이지 8곳의 기계용 정보 표기는 <br>평균 20점이었습니다</h2>
  <p class="sec-lead">2026년 8월, 치과 홈페이지 8곳의 공개 HTML 소스를 10개 항목 50개 체크포인트로 채점한 결과입니다. 점수가 가장 높은 항목과 가장 낮은 항목이 같은 정보를 다룹니다.</p>
  ...
  <div class="ev-grid">
    <div>
      ...
      <p class="ev-note"><b>두 점수는 같은 원장님 이력을 가리킵니다.</b> 전문의 자격도, 수련 병원도, 학회 경력도 홈페이지에는 적혀 있었습니다. 검색엔진과 AI가 읽는 형식으로는 옮겨져 있지 않았습니다.</p>

      <div class="ev-check">
        <p class="ev-check-h">30초 자가 점검</p>
        <p class="ev-check-s">페이지 소스 보기 <i>→</i> Ctrl+F <i>→</i> <code>ld+json</code></p>
        <p class="ev-check-p">아무것도 안 나오면 0점입니다. 병원 이름과 주소만 나오면 20점 근처로, 조사 표본의 중앙값입니다.</p>
      </div>
    </div>
    ...
    <div>
      ...
      <p class="ev-foot"><b>노란 2개 항목</b>이 AI 검색 노출을 결정합니다. 나머지 8개 항목을 올려도 이 2개가 비면 AI는 다른 사이트를 인용합니다.</p>
    </div>
  </div>

  <div class="ev-strip">
    <div>
      <p class="ev-dots-h"><b>기계용 정보 표기, 7곳 개별 점수</b> — 12 · 15 · 15 · 20 · 20 · 28 · 30</p>
      <div class="ev-plot">
      ...
      <p class="ev-dots-foot">중앙값 20점, <b>30점을 넘긴 곳은 없습니다.</b> SEO 종합에서 84점으로 가장 높았던 곳도 이 항목만은 28점이었습니다. 표본 8곳 모두가 아직 손대지 않은 항목입니다.</p>
    </div>
    <div>
      <p class="ev-acts-h">점수마다 근거를 같이 적었습니다.</p>
      <p class="ev-acts-p">채점 기준 50개와 8곳 결과를 전부 공개했습니다. 다른 업체 견적서를 받으셨을 때 항목별로 대조해 보실 수 있습니다.</p>
      <div class="ev-acts">
      ...
      <p class="ev-src">공개된 HTML 소스만 확인했습니다. 병원명은 A–H로 익명 처리했으며, 이 점수는 검색 순위나 매출을 예측하지 않습니다. 표본이 20곳을 넘으면 기준을 다시 맞추고 갱신합니다.</p>
    </div>
  </div>
</div></section>
...
<section class="section" id="work">
  <div style="display:flex;justify-content:space-between;align-items:flex-end;flex-wrap:wrap;gap:16px">
    <div><div class="overline">/WORK · SELECTED WORK</div><h2 class="sec-h2">치과 8곳을 10개 항목 50개 기준으로 <br>직접 채점했습니다</h2></div>
  ...
  <a class="sec-link" href="https://dental-seo-report.vercel.app/" target="_blank" rel="noopener">채점 기준 50개 전부 보기 →</a>
  ...
  <div class="dx-grid">
    <article class="dx">
      ...
      <p class="dx-note">표본에서 검색 점수가 가장 높았습니다. 사이트 구조도 91점. <b>그런데 기계용 정보 표기만은 28점</b>으로, 나머지 7곳과 같은 구간에 있었습니다.</p>
...
<section class="section panel" id="results"><div class="wrap">
  ...
  <div class="res-block">
    ...
    <div class="psi-shots">
      <figure class="psi-shot">
        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/img/psi-mobile.webp' ) ); ?>" alt="PageSpeed Insights 모바일 측정 결과 — 성능 100, 접근성 100, 권장사항 100, 검색엔진 최적화 100, 에이전트형 브라우징 3/3. FCP 1.0초 · LCP 1.7초 · TBT 0ms · CLS 0.003 · SI 1.8초"
             width="1200" height="1269" loading="lazy" decoding="async">
        <figcaption><b>치과 ④ · 모바일 측정</b> · 2026년 8월 31일 22:00 · 주소와 사이트 미리보기는 가렸습니다</figcaption>
      </figure>
      <figure class="psi-shot">
        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/img/psi-desktop.webp' ) ); ?>" alt="PageSpeed Insights 데스크톱 측정 결과 — 성능 100, 접근성 100, 권장사항 100, 검색엔진 최적화 100, 에이전트형 브라우징 2/2. FCP 0.4초 · LCP 0.6초 · TBT 10ms · CLS 0.006 · SI 0.6초"
             width="1200" height="1288" loading="lazy" decoding="async">
        <figcaption><b>치과 ⑤ · 데스크톱 측정</b> · 2026년 8월 31일 12:39 · 주소와 사이트 미리보기는 가렸습니다</figcaption>
      </figure>
    </div>
    <div class="psi-cards">
  ...
  <p class="sec-caption"><b>세 곳 모두 직전 90일 클릭이 한 자리였습니다.</b> 740클릭은 6클릭에서, 74클릭은 1클릭에서 온 값이라 배수만 보시면 실제 크기를 잘못 읽게 됩니다. · 네이버 서치어드바이저 최근 90일 기준(2026년 9월 측정) · PageSpeed Insights 2026년 8월 31일 측정(실험실 기준, 실사용자 데이터 없음) · 병원명·주소·도메인은 가렸습니다 · 클릭률 1.2%는 업계 평균을 넘는 값이 아닙니다. 이 표는 유입이 늘었다는 사실까지만 말합니다 · 같은 조건에서 같은 결과를 보장하지 않습니다</p>
...
<section class="section navy" id="process"><div class="wrap">
  ...
  <h2 class="sec-h2" style="color:#fff">진단·설계·제작·운영 4단계를 <br>한 팀이 맡습니다</h2>
...
<section class="section" id="why">
  ...
  <p class="sec-lead">저희가 채점한 8곳에서 나온 실측값 3가지입니다.</p>
  ...
  <div class="grid-3" style="margin-top:clamp(40px,5vw,64px)">
    <div class="step">
      ...
      <div class="stat">0<small>7곳 중 30점을 넘긴 병원 수</small></div>
    </div>
    <div class="step">
      <div class="num">02</div>
  ...
  <a class="sec-link" href="https://dental-seo-report.vercel.app/" target="_blank" rel="noopener">채점 기준과 8곳 결과 전부 보기 →</a>
</section>
...
<section class="section" id="faq">
  ...
  <div class="faq">
    <div class="faq-row"><h3>씨클로는 어떤 회사인가요?</h3><div class="faq-a">
      ...
      <p>한 팀으로 가는 이유가 있습니다. 나눠 맡기면 각자 자기 영역만 최적화합니다. 디자인 업체는 화면을, 광고 업체는 클릭 단가를 봅니다. 그 사이에서 &ldquo;검색엔진과 AI가 이 페이지를 읽을 수 있는가&rdquo;는 아무도 보지 않습니다. 저희가 치과 8곳을 채점했을 때 가장 낮게 나온 항목이 정확히 그 자리였습니다.</p>
    </div></div>
    <div class="faq-row"><h3>GEO(생성형 검색 최적화)가 무엇인가요?</h3><div class="faq-a">
      ...
      <p>다만 둘은 분리된 기술이 아닙니다. AI는 검색 지면에서 만들어진 데이터를 근거로 답을 씁니다. GEO는 SEO 기반 위에서만 작동합니다.</p>
      <p>지금은 격차가 좁습니다. 저희 조사에서 검색 점수는 39점에서 84점까지 벌어졌는데, AI 점수는 31점에서 56점 사이에 몰려 있었습니다. 검색은 신경 쓴 곳과 안 쓴 곳이 갈렸고, AI는 아직 다 같이 낮습니다.</p>
    </div></div>
    ...
    <div class="faq-row"><h3>노출 성과를 보장해 주시나요?</h3><div class="faq-a">
      ...
      <p>검색 순위는 경쟁 상황과 콘텐츠 축적에 따라 달라지고, 알고리즘은 공개돼 있지 않습니다. 저희가 채점한 10개 항목도 읽을 수 있는 상태인지를 잰 것이지 순위를 예측하는 값이 아닙니다.</p>
    ...
    <div class="faq-row"><h3>지금 홈페이지를 새로 만들어야 하나요?</h3><div class="faq-a">
      <p>대부분은 아닙니다.</p>
      <p>저희가 채점한 8곳 중 디자인이 문제였던 곳은 없었습니다. 점수가 낮게 나온 곳도 화면은 대부분 좋았습니다. 무너진 자리는 기계가 읽는 층이었고, 그건 대개 지금 사이트 위에서 고칠 수 있습니다.</p>
