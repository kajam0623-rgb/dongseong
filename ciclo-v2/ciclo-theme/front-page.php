...
<section class="section navy evidence" id="evidence"><div class="wrap">
  ...
  <p class="sec-lead">2026년 8월, 치과 홈페이지 8곳의 공개 HTML 소스를 10개 항목 50개 체크포인트로 채점한 결과입니다. 가장 높은 칸과 가장 낮은 칸이 같은 정보를 다룹니다.</p>
  ...
  <div class="ev-grid">
    ...
    <div>
      ...
      <p class="ev-foot"><b>노란 2개 항목</b>이 AI 검색 노출을 결정합니다. 나머지 8개 항목을 올려도 이 2칸이 비면 AI는 다른 사이트를 인용합니다.</p>
    </div>
  </div>
  ...
  <div class="ev-strip">
    ...
    <div>
      <p class="ev-acts-h">점수 옆에 그 점수가 나온 근거를 같이 답니다.</p>
      <p class="ev-acts-p">채점 기준 50개와 8곳 결과를 그대로 열어 뒀습니다. 다른 업체 견적서를 받으셨을 때 항목을 짚어 보실 수 있습니다.</p>
      <div class="ev-acts">
