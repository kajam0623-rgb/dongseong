 ...
 * 페이지 /contact/
 *
 * 마크업은 pages/Contact.html 를 그대로 옮긴 것입니다.
...
get_header();
?>
<div class="ciclo-page" id="ciclo-contact">
<header class="page-hero">
  <div class="overline">/CONTACT</div>
  <h1 class="display">Let's <br><span class="blue">Talk.</span></h1>
  <p class="lead">지금 쓰시는 홈페이지 주소 하나만 주셔도 됩니다. 저희가 먼저 채점해서, 하루 안에 점수와 고칠 순서를 담아 답장드립니다.</p>
</header>
<section class="section" style="padding-top:0">
  <div class="contact-grid">
    <div style="display:flex;flex-direction:column;gap:14px">
      <a class="channel kakao" href="https://open.kakao.com/o/s8oziiEi" target="_blank" rel="noopener"><div><div class="lab">KAKAO</div><div class="big">카카오톡 1:1 문의</div><div class="sub" style="opacity:.7">가장 빠른 답변 · 평일 10:00–19:00</div></div><span class="arr">→</span></a>
      <a class="channel mail" href="mailto:kajam0623@naver.com"><div><div class="lab">EMAIL</div><div class="big arch">kajam0623@naver.com</div><div class="sub">자료 첨부가 필요한 문의</div></div><span class="arr">→</span></a>
      <a class="channel phone" href="tel:010-8017-2001"><div><div class="lab">PHONE</div><div class="big arch">010-8017-2001</div><div class="sub">급한 문의 · 통화 상담</div></div><span class="arr">→</span></a>
    </div>
    <div class="contact-proc">
      ...
      <div class="cp-steps">
        ...
        <div class="cp-step"><div class="num">03</div><div><div class="t">제안 · 견적</div><p>범위와 일정, 비용을 담은 제안서를 보내드립니다.</p></div></div>
      </div>
