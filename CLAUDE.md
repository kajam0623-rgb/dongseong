...
> **v3 작업 시 필독**: `설계서-v3.md`가 이 문서의 상위 참조다. 토큰 3계층, 섹션 컴포저 전환, 모션 토큰, 배포(SaaS), 워드프레스 연동의 모든 구현은 설계서의 스키마와 스프린트 순서(S1~S7)를 따른다. S1 골든 테스트 없이 섹션 컴포저 전환에 착수하지 말 것.
